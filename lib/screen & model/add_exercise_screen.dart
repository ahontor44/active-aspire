...
class WorkoutDetailScreen extends StatelessWidget {
  final String workout; const WorkoutDetailScreen({super.key, required this.workout});
  @override
  Widget build(BuildContext context) {
    final workoutIndex = Provider.of<HomeScreenModel>(context) .items .indexWhere((item) => item["title"] == workout);
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Workout Details'),
    ), body: Consumer<HomeScreenModel>( builder: (context, model, child) {
                ...
                return ListTile( title: Text('${exercise['name']
                  ...
                  trailing: PopupMenuButton<String>(
                    onSelected: (String result) {
                      ...
                      } else if (result == 'Delete') { model.deleteExercise(workoutIndex, index); }
                      },
                    itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[ PopupMenuItem<String>( value: 'Edit', child: Text('Edit'),
                    ),
  ...
  void _showAddExerciseDialog(BuildContext context, HomeScreenModel model, int workoutIndex) {
    ...
    showDialog( context: context, builder: (context) {
      return AlertDialog( title: Text('Add Exercise'),
        content: Column(
